...
public class usuario {
    ...
    public String toString() {
        return "usuario{" + "idUsuario=" + idUsuario + ", nombres=" + nombres + ", apellidos=" + apellidos + ", nombreUsuario=" + nombreUsuario + ", correo=" + correo + ", contrase\u00f1a=" + contraseña + ", rol=" + rol + ", detalles_meta_usuario=" + detalles_meta_usuario + '}';
    }
